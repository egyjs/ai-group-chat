    ...
    return (
        <div className="flex h-full w-full bg-background-light font-sans text-text-primary-light dark:bg-background-dark dark:text-text-primary-dark">
            <main className="relative flex h-full flex-1 flex-col">
                {/* Header */}
                <header className="z-10 flex items-center justify-between border-b border-border-light bg-surface-light/95 px-6 py-3 shadow-sm backdrop-blur dark:border-border-dark dark:bg-surface-dark/95">
                ...
                {/* Composer */}
                <footer className="border-t border-border-light bg-surface-light/95 px-4 py-4 backdrop-blur dark:border-border-dark dark:bg-surface-dark/95">
                    <div className="mx-auto max-w-4xl">
                        ...
                        <div className="flex items-end gap-2 rounded-2xl border border-border-light bg-background-light/60 p-2 shadow-sm focus-within:border-primary focus-within:ring-1 focus-within:ring-primary/20 dark:border-border-dark dark:bg-background-dark/60 transition-all">
                            <Button
                                variant="ghost"
                                size="icon"
